...
class tclacClimate : public climate::Climate, public esphome::uart::UARTDevice, public PollingComponent {
	...
	private:
		...
		uint8_t switch_gen_mode = 0; // Уровень режима генератора (0=Выкл, 1=L1, 2=L2, 3=L3)
		uint8_t current_gen_mode = 0; // Уровень режима генератора, прочитанный из ответа платы (byte 47)
	...
	public:
		...
		void set_gen_mode(uint8_t level);
		uint8_t get_gen_mode() { return current_gen_mode; }
