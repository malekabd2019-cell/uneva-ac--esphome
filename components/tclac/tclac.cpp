...
void tclacClimate::readData() {
	...
	// --- قراءة وضع المولد من المكيف (البايت 18) وتحديث القائمة المنسدلة عند التغيير بالريموت ---
...
void tclacClimate::takeControl() {
	...
	dataTX[16] = 0x00;	//??
	dataTX[17] = 0x00;	//??
	dataTX[18] = this->gen_mode_;	// وضع المولد (Byte 18)
...
void tclacClimate::set_supported_fan_modes(const std::set<clim
